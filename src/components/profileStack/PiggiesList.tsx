...
import type { PiggiesListProps } from '@/types/components';
import { Colors, Sizing, Typography } from '@/styles';

function PiggiesList({ piggies }: PiggiesListProps): JSX.Element {
  const imageUri =
  ...
  const renderPiggie = ({ item }: { item: Backend.User }): JSX.Element => (
